...
export default function ViewTeam() {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-4xl font-bold text-center text-teal-600 mb-8">Your Team</h1>

      <div className="text-lg text-center mb-6">Team Status: {players.length}/11 players selected</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {players.map((player) => (
          <div key={player.id} className="bg-white rounded-lg shadow-md p-4 flex flex-col border-4 border-teal-500">
            ...
            <button
              className="mt-auto bg-blue-400 text-white py-2 px-4 rounded hover:bg-blue-600 transition"
      ...
      {players.length < 11 ? (
        <div className="mt-8 p-6 bg-gray-100 border border-dashed text-center rounded-lg">
